...
jQuery.extend({
	...
	dobPicker: function(params) {
		...
		// set the defaults		
		if (typeof(params.dayDefault)==='undefined') params.dayDefault = 'Ημέρα';
		if (typeof(params.monthDefault)==='undefined') params.monthDefault = 'Μήνας';
		if (typeof(params.yearDefault)==='undefined') params.yearDefault = 'Έτος';
