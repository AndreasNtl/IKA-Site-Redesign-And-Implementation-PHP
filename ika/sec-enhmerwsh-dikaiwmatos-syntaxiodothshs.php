...
<html lang="en">
  <head>
    ...
    <title>IKA-ETAM Ενημέρωση δικαιώματος συνταξιοδότησης</title>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-content">
							...
							<li><a href="./sec-enhmerwsh-dikaiwmatos-syntaxiodothshs.php"> <b>Ενημέρωση δικαιώματος συνταξιοδότησης</b> </a></li>
						</ul>
					</li>
