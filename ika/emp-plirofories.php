...
<html lang="en">
  <head>
    ...
    <title>IKA-ETAM Πληροφορίες για δικαιώματα και υποχρεώσεις εργοδότη</title>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-content">
							...
							<li><a href="./emp-plirofories.php"> <b>Πληροφορίες για δικαιώματα και υποχρεώσεις</b> </a></li>
						</ul>
					</li>
