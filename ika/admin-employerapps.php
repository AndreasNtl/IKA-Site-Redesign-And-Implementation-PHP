...
if (isset($_POST['action']) && isset($_POST['id'])) {
  if ($_POST['action'] == 'Έγκριση') {
	if(mysqli_query($con, "UPDATE employer_applications SET standBy='" . true . "', approval='" . true . "' WHERE id='" . $_POST['id'] . "' ")){
 
	} 

  }
  if ($_POST['action'] == 'Απόρριψη') {
	if(mysqli_query($con, "UPDATE employer_applications SET  standBy='" . true . "', approval='" . false . "' WHERE id='" . $_POST['id'] . "' ")){
	...
	<br>
      ...
      <thead>
	   ...
	   <tbody>
	  	...
	  	<?php      
		$query = "SELECT * FROM employer_applications" ;
